				...
				f = {
				        ...
				        for (var i = 0; i < files.length; i++) {
				            ...
				            if (status !== true) {
				                ...
				                if (!status[2]) {
				                    ...
				                    status[1] ? DialogWarning(status[1]) : null;
				                }
				    ...
				    thumbnails: {
				                    ...
				                    if (item) {
				                        if (item.upload && item.upload.status != 'successful') {
				                            ...
				                            if (n.thumbnails.removeConfirmation) {
				                                SwAlert.Confirm(AlertTitle.Confirm, f._assets.textParse(n.captions.removeConfirmation, item), function () {
				        ...
				        generateFileIcon: function (format, extension) {
                            ...
                            var el = '<div class="fileuploader-item-icon"><img src="' + sPath + '/Images/IconSystem/' + nameIcon + '.png"></div>';
				            //debuggerhttp://localhost:32728/Images/IconSystem/wordImage.png
				    ...
				    files: {
				        ...
				        add: function (file, prop) {
				            ...
				            file.data = file.nID != undefined ? file.nID : 0;
				            var name = file.name,
								size = file.size,
								size2 = size != "" ? f._assets.bytesToText(size) : "",
								type = file.type,
								...
								data = file.data,
                                nID = file.nID != undefined ? file.nID : file.data.nID,
